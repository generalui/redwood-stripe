...
export type ListPaymentsQuery = { __typename?: 'Query', payments: Array<{ __typename?: 'Payment', stripeId: string, fromEmail: string, amount: number, status: string, receiptUrl: string, type: string, connectedAccountEmail?: string | null, connectedAccountId?: number | null }> };
...
export type SellersQuery = { __typename?: 'Query', sellers: Array<{ __typename?: 'User', id: number, email: string }> };
